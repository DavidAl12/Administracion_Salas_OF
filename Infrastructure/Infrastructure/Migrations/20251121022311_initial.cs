    ...
    public partial class salaass : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrestamosSala", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrestamosSala_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PrestamosSala_Salas_SalaId",
                        column: x => x.SalaId,
                        principalTable: "Salas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrestamosEquipo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrestamosEquipo_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrestamosEquipo_EquipoId",
                table: "PrestamosEquipo",
                column: "EquipoId");

            migrationBuilder.CreateIndex(
                name: "IX_PrestamosEquipo_UsuarioId",
                table: "PrestamosEquipo",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_PrestamosSala_SalaId",
                table: "PrestamosSala",
                column: "SalaId");

            migrationBuilder.CreateIndex(
                name: "IX_PrestamosSala_UsuarioId",
                table: "PrestamosSala",
                column: "UsuarioId");
